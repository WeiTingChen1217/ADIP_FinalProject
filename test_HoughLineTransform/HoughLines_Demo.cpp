...
{
    /// Read the image
    src = imread( "/Users/WeiTing_Chen/Desktop/ADIP_FinalProject/output/test_morphology/IMG_2367-2_1_0_08.jpg", IMREAD_COLOR );
...
void Canny_Operations( int, void* )
{
    Canny(src_gray, edges, threshold1, threshold2, 3);
//    threshold(edges, edges, 128, 255, THRESH_BINARY_INV);  //反轉影像，讓邊緣呈現黑線
